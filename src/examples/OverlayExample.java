 ...
 */
public class OverlayExample implements WebcamImageTransformer {

	private static final BufferedImage IMAGE_FRAME = getImage("Untitled.png");
	...
	private static final BufferedImage getImage(String image) {
		try {
			return ImageIO.read(OverlayExample.class.getResourceAsStream("/" + image));
		} catch (IOException e) {
